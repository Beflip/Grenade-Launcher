Shader "Custom/PaintMain"{
    Properties{
        ...
        PAINTER_COLOR_BLEND("Color Blend Keyword", FLOAT) = 0
    }

    SubShader{
        CGINCLUDE

#include "Assets/Resources/PainterFoundation.cginc"
    ...
    ENDCG
        ...
        Pass{
            CGPROGRAM
#pragma multi_compile PAINTER_COLOR_BLEND_USE_CONTROL PAINTER_COLOR_BLEND_USE_BRUSH PAINTER_COLOR_BLEND_NEUTRAL PAINTER_COLOR_BLEND_ALPHA_ONLY
#pragma vertex vert
#pragma fragment frag
            ...
            float4 frag(v2f i) : SV_TARGET {
                ...
                if (IsPaintRange(i.uv, _PaintUV, h, _BrushRotate)) {
                    ...
                    return PAINTER_COLOR_BLEND(base, brushColor, _ControlColor);
                }
                return base;
            }
