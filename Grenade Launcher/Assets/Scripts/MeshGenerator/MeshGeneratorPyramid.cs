...
public class MeshGeneratorPyramid : MeshGenerator
{
    ...
    protected override Vector3[] CalculateVertices()
    {
        Vector3[] vertices = new Vector3[]
        {
            ...
            _corners[4], _corners[4], _corners[0], _corners[3],
            _corners[4], _corners[4], _corners[1], _corners[0],
            _corners[4], _corners[4], _corners[3], _corners[2],
            _corners[4], _corners[4], _corners[2], _corners[1]
        };
